...
<head>
  ...
  <!-- Icons -->
  <link href="<?php echo e(asset('s/plugins/nucleo/css/nucleo.css')); ?>j" rel="stylesheet" />
    ...
    <nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark">
      <div class="container px-4">
        <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
          <img src="<?php echo e(asset('img/brand/logo.png')); ?>" />
        </a>
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">Bienvenido Inventario Web</h1>
              <h1 class="text-lead text-light"><?php echo $__env->yieldContent('title', 'bienvenidos'); ?></h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              © 2023 <a href="/" class="font-weight-bold ml-1" ><?php echo e(config('app.name')); ?></a>
            </div>
          </div>
          <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
              ...
              <li class="nav-item">
                <a href="https://github.com/creativetimofficial/argon-dashboard/blob/master/LICENSE.md" class="nav-link" target="_blank">ISFT °38</a>
              </li>
            </ul>
          </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\inventarioWeb\resources\views/layouts/form.blade.php ENDPATH**/ ?>